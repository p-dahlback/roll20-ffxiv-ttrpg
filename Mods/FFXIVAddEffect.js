        ...
        for (let a of args) {
            ...
            switch (parts[0].toLowerCase()) {
                ...
                default: {
                    ...
                    logger.d("Specs: " + JSON.stringify(specifications));
                    for (let specification of specifications) {
                        ...
                        logger.d("Matches " + JSON.stringify(formatMatch));
