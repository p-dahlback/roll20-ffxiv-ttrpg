...
const EffectData = function() {
    this.effects = {
        ...
        thunder: { matches: ["thunder"], type: "special", maskedType: "dot(x)", special: "Thunder", statusType: "Enfeeblement", marker: "thunder", name: "Thunder", expiry: "phase", curable: true, description: "Damages the character by a given amount at the end of the [Adventurer Step]." },
